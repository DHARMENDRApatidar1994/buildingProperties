...
import propertyImage from "../../../assets/Images/AddListing/propertyimage.png";
      ...
      <div>
        <div className=" h-[640px] mt-[40px] ">
          ...
          <div className=" h-[50px] text-[28px] font-semibold mb-[20px] ">
            ...
            <div
              className="w-[40px] h-[40px] float-right mt-[10px]"
          ...
          <div className=" h-[704px]">
            ...
            <div className="mx-[24px]  h-[196px] ">
              <div className="w-[920px] h-[196px] ">
                <p className=" w-[819px] h-[156px] ml-[40px] my-[20px]   text-[18px] text-[#0D0E0F] font-normal  ">
                  ...
                  buyers' hearts. Discover what makes these homes stand out in
                  the competitive market, and find your own slice of British
                  real estate... Explore the hottest property trends in the UK!
                  From charming urban flats to serene countryside estates, our
                  latest blog dives into the top-selling properties that are
                  capturing buyers' hearts.
                </p>
                <img
                  src={userImg}
                  alt=""
            ...
            <div className=" h-[110px] ">
              <p className="pl-[16px] py-[16px] w-[712px] m-[23px] h-[110px] bg-[#EBFFFD] rounded-[12px] float-right">
                Hello, My pleasure having to connect with you here. Thanks for
                the warm compliments. As for your offer, be rest assured you’re
                in the right place. I’ll like to know more about the project and
                of course, I’m down for a chat.{" "}
                <span className=" float-right px-[8px]">9:55 pm</span>
              </p>
            </div>
            {/* <div className="text-end "></div> */}

            <div className="mx-[24px]  my-[20px] w-[962px] h-[200px]  ">
              ...
              <textarea
                ...
                className="p-[10px] ml-[45px] mt-[-40px] w-[912px] h-[195px] border-[1px] border-[#E8AE00]  rounded-md shadow-md "
              />
            </div>
            <div className="mx-[24px]  h-[50px]">
