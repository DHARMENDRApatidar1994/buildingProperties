    ...
    <div>
       <div className='rentsec1'>
        ...
        <div className='frentinput'>
            ...
            <h6 className='col-10 mt-5 fw-normal'>Price per</h6>
         ...
         <label className='ms-3' for="age2">Last 24 hours</label> 
